# Привет, всем!
# 
# Но вообще, хорошо бы узнать имя собеседника, 
# а уже потом его приветствовать.
# Напишите диалоговую программу, 
# которая сначала познакомится со своим пользователем, 
# а затем поздоровается с ним.
# 
# Формат ввода
